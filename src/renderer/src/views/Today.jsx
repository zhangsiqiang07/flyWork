                              ...
                              {ws && (
                                ...
                                >
                                  ...
                                  <span style={{ fontSize: 11, color: 'var(--text-muted)' }}>
                                    开始于 {formatRelTime(session.startedAt)}
                                  </span>
                                </div>
                              )}
                              {session.notes && (
                              ...
                              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                                ...
                                {ws && ws.actions[0] && (
                                  <button
                                    ...
                                    onClick={() => handleActionClick(ws.actions[0], ws)}
                                  >
                                    ⚙️ {ws.actions[0].name}
                                  </button>
                                )}
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    {isDemoMode ? (
                      ...
                      >
                        已连接
                        {authStatus.organizationName ? ` · ${authStatus.organizationName}` : ''}
                      </span>
                    ) : (
                      <span
                        className="badge"
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            transition: 'all 120ms ease',
                            borderColor:
                              runningTasks > 0 ? 'rgba(79,158,248,0.35)' : 'var(--border)'
                          }}
                ...
                todayBugs.length === 0 && (
                  <div className="empty-state">
                    ...
                    <div className="empty-state-desc">
                      选择一个工作空间开始新的会话，或者从智能编排与缺陷中心快速启动。
                    </div>
                    <button
