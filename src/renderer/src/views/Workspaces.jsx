export default function Workspaces({ workspaces, sessions, onOpenWorkspace }) {
  return (
        ...
        <div className="workspace-grid">
          {workspaces.map((ws, i) => {
            ...
            return (
              <div
                ...
                style={{ animation: `fadeIn 200ms ease ${i * 40}ms both` }}
              >
                ...
                <div style={{ marginBottom: 12 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                    <span style={{ fontFamily: 'monospace', fontSize: 11, color: 'var(--accent-blue)' }}>⑂ {ws.gitBranch}</span>
          ...
          >
            <div style={{ textAlign: 'center', color: 'var(--text-muted)' }}>
              ...
              <div style={{ fontSize: 11, marginTop: 4 }}>关联本地项目、Git 仓库、文档</div>
            </div>
          </div>
        </div>
      </div>
